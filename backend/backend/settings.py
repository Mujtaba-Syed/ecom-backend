...
SECRET_KEY = 'django-insecure-2@k191=$&#k82+)kpu*q6ie%h^d&2ye8l)+q4ey-9#004(j3^q'
...
# CORS settings for cookie support
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'AuthUser.authentication.CookieJWTAuthentication',  # Custom cookie-based JWT auth
...
SIMPLE_JWT = {
    ...
    'AUTH_COOKIE_HTTP_ONLY': True,  # HttpOnly flag (prevents JavaScript access)
